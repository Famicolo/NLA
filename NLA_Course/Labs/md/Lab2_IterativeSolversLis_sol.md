...
- Download the matrix A (`matA.mtx` in  matrix market format) and vector b (`vecB.mtx` in  matrix market format) from the Lab2 folder in webeep and move them to the folder `lis-2.0.34/test`. 
